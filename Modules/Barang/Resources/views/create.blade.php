                  ...
                  {{-- <div class="row"> --}}
                      ...
                      <div class="col-12">
                        <div class="form-group">
                          ...
                          <input type="number" id="harga_beli" class="form-control" name="harga_beli" placeholder="Harga Beli">
                        </div>
                      </div>
                      <div class="col-12">
                        <div class="form-group">
                      ...
                      <div class="col-12">
                        <div class="form-group">
                          ...
                          <input type="number" id="modal" class="form-control" name="modal" placeholder="Modal">
                        </div>
                      </div>
                      <div class="col-12">
