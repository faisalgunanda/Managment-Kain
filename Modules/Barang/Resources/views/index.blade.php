...
<section id="basic-datatable">
	<div class="row">
		<div class="col-12">
            ...
            <button id="addRow" onclick="window.location.href='/barang/create'" class="btn btn-primary mb-2 float-right"><i class="feather icon-plus"></i>&nbsp; Tambah Barang Baru</button>
...
<script>
  $(document).ready(function () {
    ...
    $("#kontol").DataTable({
      ...
      {data: 'panjang', name: 'panjang', searchable:false, orderable:false},
      {data: 'satuan', name: 'satuan', searchable:false, orderable: false},
      {data: 'stock_tersisa', name: 'stock_tersisa', searchable:false, orderable:false},
